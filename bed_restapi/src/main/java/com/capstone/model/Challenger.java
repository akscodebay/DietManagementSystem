...
public class Challenger {
	...
	public Challenger(String userId, String name, String gender, Long mobileNumber, String email, String address,
			...
			String referredByCode, String referralCode, String password) {
		super();
		this.userId = userId;
		this.name = name;
		this.gender = gender;
	...
	public String toString() {
		return "Challenger [userId=" + userId + ", name=" + name + ", gender=" + gender + ", mobileNumber="
				...
				+ pregnantStatus + ", referredByCode=" + referredByCode + ", referralCode=" + referralCode
				+ ", password=" + password + ", batch=" + batch + ", group=" + division + "]";
	}
